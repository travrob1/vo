...
/**
 * Test for /posts/{id}/tidbits/{tid}
 */
Test('/posts/{id}/tidbits/{tid}', function (t) {
    ...
    Parser.validate(apiPath, function (err, api) {
         ...
         */
        t.test('test getTidbitById get operation', function (t) {
            Mockgen().requests({
                ...
                request.end(function (err, res) {
                    ...
                    var validate = Validator(api.paths['/posts/{id}/tidbits/{tid}']['get']['responses']['200']['schema']);
